  ...
  return (
    <DrawerPortal>
      ...
      <DrawerPrimitive.Content
        ...
        {...props}
      >
        {/* Handle bar — only shows for bottom drawer */}
        <div className="bg-gray-300 mx-auto mt-3 hidden h-1.5 w-12 shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  )
...
function DrawerFooter({ className, ...props }) {
  return (
    <div
      ...
      className={cn("mt-auto flex flex-col gap-2 p-4 pb-6", className)}
      {...props}
    />
  )
}
...
function DrawerTitle({ className, ...props }) {
  return (
    <DrawerPrimitive.Title
      ...
      className={cn("text-gray-900 font-semibold text-base", className)}
      {...props}
    />
  )
}
